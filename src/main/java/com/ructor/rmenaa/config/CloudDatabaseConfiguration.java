package com.ructor.rmenaa.config;
...
@Configuration
@EnableMongoRepositories("com.ructor.rmenaa.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.ructor.rmenaa.config.dbmigrations");
